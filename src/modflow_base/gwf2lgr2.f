C-----VERSION 1.0 15FEBRUARY2006 GETNAMFILLGR  -- Moved to BAS_UTIL Module
!!!      SUBROUTINE GETNAMFILLGR(INLGR,FNAME,IGRID)   ! INLGR = LGR unit number 
!!!      USE BAS_UTIL,    ONLY: OPEN_NAME_FILE
...
C       (MAY BE POSSIBLE TO BE DONE WITH IUNIT THROUGH GLOBAL AS WELL)
      IF(IUNIT(61).NE.0) THEN                                           !WSCHMID   !seb CHANGED FROM IUNIT(62)
        IFMPGRID=IGRID                                                  !WSCHMID
      ELSE                                                              !WSCHMID
        IFMPGRID=0                                                      !WSCHMID
      ENDIF                                                             !WSCHMID
C
      IF(IUNIT(44).NE.0) THEN                                           !WSCHMID
...
C     INITIALIZE THE INTERIOR SOLUTION OF THE CHILD GRID.
C
