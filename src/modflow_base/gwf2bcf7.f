...
C     ------------------------------------------------------------------
     ...
     1                      CC,CV,IFREFM,KND,BOTM,NOCBC !swm: added BOTM
     ...
     1                      LAYCON,LAYAVG,HY,SC1,SC2,WETDRY,CVWD,TRPY
      USE CONSTANTS,         ONLY: NL, BLN   ! BLN = NL//NL
...
!         CALL USTOP(' ')
     ...
     +                 'INVALID INTERBLOCK T CODE:'//NUM2STR(LAYAVG(I)))
      END IF
