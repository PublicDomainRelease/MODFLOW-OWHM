...
CBARC**ADD INRECH FOR CFP                                               !TR: 2017 07 20 CFPv2
        INTEGER,SAVE,POINTER    :: INRECH                               !TR: 2017 07 20 CFPv2
      TYPE GWFRCHTYPE
...
C        SPECIFICATIONS:
C     ------------------------------------------------------------------
      USE GLOBAL,      ONLY:IOUT,NCOL,NROW,IFREFM,NOCBC
      USE GWFRCHMODULE,ONLY:NRCHOP,IRCHCB,NPRCH,IRCHPF,RECH,IRCH, INRECH!TR: 2017 07 20 CFPv2
C
      CHARACTER*200 LINE
      CHARACTER*4 PTYP
C     ------------------------------------------------------------------
...
C1-------ALLOCATE SCALAR VARIABLES.
      ...
      ALLOCATE(NPRCH,IRCHPF,INRECH)                                     !TR: 2017 07 20 CFPv2
C
C2------IDENTIFY PACKAGE.
      IRCHPF=0
        WRITE(IOUT,1)IN
...
C     ------------------------------------------------------------------
      ...
      USE GWFRCHMODULE,ONLY:NRCHOP,NPRCH,IRCHPF,RECH,IRCH,INRECH        !TR: 2017 07 20 CFPv2
C
