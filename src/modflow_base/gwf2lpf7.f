...
C        SPECIFICATIONS:
C     ------------------------------------------------------------------
      USE GLOBAL,  ONLY:NCOL,NROW,NLAY,ITRSS,LAYHDT,LAYHDS,LAYCBD,NOCBC,
...
C seb added output of final array
      IF(PROPPRINT.NE.'') CALL PRINTARRAY(IGRID,1,PROPPRINT,IOUT)
C
C9------RETURN
