...
! ...  mathematical constants
  ...
  IMPLICIT NONE
  SAVE
  PRIVATE::kdp                                                                  !seb ADDED PRIVATE TO PREVENT CONFLICTS WITH kpd from machine_constants
  DOUBLE PRECISION, PARAMETER :: pi = 3.1415926535897932_kdp, twopi = 2_kdp*pi  !seb CHANGED 2 to 2_kdp to ensure double precision multiplication; Increased precision of Pi from 3.141592653589
