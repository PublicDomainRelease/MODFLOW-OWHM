...
!    
      ...
      MODULE GENERIC_OPEN_INTERFACE!, ONLY: GENERIC_OPEN, GENERIC_SCRATCH_FILE, NULL_FILE, GENERIC_NULL_FILE_OPEN, FORCE_UNIT_CLOSE, SET_GENERIC_OPEN_WARN_IU, UTF8_BOM_OFFSET_REWIND, OPEN_NEW_READ_UNIT, UNIT_IS_BOM
      IMPLICIT NONE
      PRIVATE
     ...
     +         UTF8_BOM_OFFSET_REWIND, OPEN_NEW_READ_UNIT, UNIT_IS_BOM
      ...
      END SUBROUTINE
      !
      SUBROUTINE GENERIC_OPEN(FNAME, IU, IOUT, ACTION, FORM,
     ...
     +        'THE RETURNED FORTRAN ERROR CODE IS: '//TRIM(CERR)//NL
           ...
           IF(PRESENT(INFILE)) THEN
              ALLOCATE(CHARACTER(700):: IN_FILE_NAM)
