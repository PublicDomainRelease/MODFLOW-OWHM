...
C----- Read file names
    1 WRITE(*,*) 'Enter name of file with unformatted hydrograph data:'
      ...
      OPEN(UNIT=inunit,FILE=FN1,FORM=FORM,ACCESS=ACCESS,STATUS='OLD')
CC
